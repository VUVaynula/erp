...
Функция ЗагрузкаДанныхСервер()
	...
	Для НомерСтроки = НачальнаяСтрока По ТабличныйДокумент.ВысотаТаблицы Цикл 
		...
		Для Каждого ЗагружаемаяКолонка Из ЗагружаемыеКолонки Цикл 
			...
			ЗначениеЯчейкиДата = ИТК_Строки.СтрокаВДату(ЗначениеЯчейки);
			Если ЗначениеЗаполнено(ЗначениеЯчейкиДата) Тогда
				
				ЗначениеЯчейки = ЗначениеЯчейкиДата;
				ТипЗначенияЯчейки = Тип("Дата");
