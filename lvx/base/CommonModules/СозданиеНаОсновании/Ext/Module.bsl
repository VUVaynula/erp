...
Процедура ПриДобавленииКомандСозданияНаОсновании(Команды, СведенияОбОбъекте, НастройкиФормы, ДопустимыеТипы = Неопределено)
	...
	бит_ОбщегоНазначенияПереопределяемый.ДобавитьКомандыСозданияНаОснованииДляТиповыхОбъектов(Команды,
		СведенияОбОбъекте, НастройкиФормы);
	Справочники.бит_ШаблоныВводаНаОсновании.ДобавитьКомандыСозданияНаОсновании(Команды, СведенияОбОбъекте, НастройкиФормы); 
