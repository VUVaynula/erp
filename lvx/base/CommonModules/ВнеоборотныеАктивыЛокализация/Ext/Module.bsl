...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Recalculate property taxes'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Enter initial information to calculate land value tax'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Enter initial information to calculate property tax'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Enter initial information to calculate vehicle tax'", КодыЯзыков); // @НСтр-1
