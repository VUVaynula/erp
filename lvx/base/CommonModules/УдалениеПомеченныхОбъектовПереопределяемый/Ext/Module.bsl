...
Процедура ПередПоискомПомеченныхНаУдаление(Параметры) Экспорт
	...
	Справочники.бит_КлючиСценарийЦФО.ПометитьНаУдалениеНеиспользуемыеКлючиАналитики();
	Справочники.бит_КлючиДоступаЦФОСтатьиОборотов.ПометитьНаУдалениеНеиспользуемыеКлючиАналитики();
