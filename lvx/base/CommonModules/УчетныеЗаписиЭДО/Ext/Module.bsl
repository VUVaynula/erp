...
Функция УдалитьУчетнуюЗапись(ИдентификаторУчетнойЗаписи) Экспорт
	...
	Исключение
		...
		ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Удаление учетной записи электронного документооборота';
														|en = 'Удаление учетной записи электронного документооборота'"),
...
Функция ВидОшибкиНедействительныеСертификаты(НаименованиеУчетнойЗаписи, ИдентификаторУчетнойЗаписи) Экспорт
	...
	ВидОшибки.ЗаголовокПроблемы = НСтр("ru = 'В учетной записи есть недействительные сертификаты';
										|en = 'В учетной записи есть недействительные сертификаты'");
	...
	ВидОшибки.ОписаниеРешения = НСтр("ru = '<a href = ""Удалите"">Удалите </a> недействительные сертификаты учетной записи';
									|en = '<a href = ""Удалите"">Удалите </a> недействительные сертификаты учетной записи'");
...
Процедура ОбработатьОшибкиСинхронизации(ДанныеДляСинхронизации, ОбработанныеУчетныеЗаписи) Экспорт
	...
	Для Каждого КлючИЗначение Из ДанныеДляСинхронизации.УчетныеЗаписиБезДоступаКСертификатам Цикл
		...
		Если КоличествоСертификатов = 1 Тогда
			ТекстОшибки = НСтр("ru = '<a href = ""Сертификаты"">Сертификат</a> доступен, но в поле ""Пользователь"" сертификата учетной записи указан пользователь, отличный от текущего';
								|en = '<a href = ""Сертификаты"">Сертификат</a> доступен, но в поле ""Пользователь"" сертификата учетной записи указан пользователь, отличный от текущего'");
		Иначе 
			ТекстОшибки = НСтр("ru = '<a href = ""Сертификаты"">Сертификаты(%1)</a> доступны, но в поле ""Пользователь"" сертификата учетной записи указан пользователь, отличный от текущего';
								|en = '<a href = ""Сертификаты"">Сертификаты(%1)</a> доступны, но в поле ""Пользователь"" сертификата учетной записи указан пользователь, отличный от текущего'");
		КонецЕсли;
	...
	Для Каждого УчетнаяЗапись Из ДанныеДляСинхронизации.УчетныеЗаписиБезДоступныхСертификатов Цикл
		...
		ТекстОшибки = НСтр("ru = 'Недоступен ни один личный сертификат из привязанных к учетной записи';
							|en = 'Недоступен ни один личный сертификат из привязанных к учетной записи'");
		ИнформацияОбОшибке = ОбработаннаяУчетнаяЗапись.ИнформацияОбОшибке;
