...
Функция ПрогрессОбновленияОбластейДанных(РежимОбновления) Экспорт
	...
	МодульОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса = ОбщегоНазначения.ОбщийМодуль("ОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса");
	ОбластиОбновленныеНаВерсию = МодульОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса.ОбластиОбновленныеНаВерсию(Метаданные.Имя, бит_ОбщегоНазначения.МетаданныеВерсия());
...
Функция ОбработчикиОбновления(Отбор = Неопределено) Экспорт
	...
	Если ЕстьФильтрОперативноеОбновление И ЕстьФильтрВыполняется 
		...
		МодульОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса = ОбщегоНазначения.ОбщийМодуль("ОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса");
		ОбновленныеОбласти = МодульОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса.ОбластиОбновленныеНаВерсию(Метаданные.Имя, бит_ОбщегоНазначения.МетаданныеВерсия());
