...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	РасшифровкаКодовОшибок.Вставить(85, НСтр("ru = 'Не заполнены реквизиты расчета партий и расчета себестоимости в движениях по регистру ""Движения Прочие активы-пассивы""';
	...
	РасшифровкаКодовОшибок.Вставить(86, НСтр("ru = 'Не правильный тип записи в сторно движениях перемещения товаров';
...
//-- НЕ УТ
	...
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Включение учета себестоимости по видам запасов';
											|en = 'Включение учета себестоимости по видам запасов'", ОбщегоНазначения.КодОсновногоЯзыка()));
