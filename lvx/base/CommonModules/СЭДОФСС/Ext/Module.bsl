...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий 		= НСтр("ru = 'Заполнение должности и основания подписи в документах «Ответ на запрос СФР для расчета пособия».';
											|en = 'Fill in the job title and signature basis in the ""Response to Social Insurance Fund request for benefit calculation"" documents.'");
...
Функция ПодготовитьВопросВПоддержку(ДокументОбъект, Вложения) Экспорт
	...
	Сообщение.Сообщение = СтрЗаменить(Сообщение.Сообщение, "[ВерсияКонфигурации]", бит_ОбщегоНазначения.МетаданныеВерсия());
