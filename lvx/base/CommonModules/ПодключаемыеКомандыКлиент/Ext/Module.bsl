...
Процедура ПродолжитьВыполнениеКоманды(ПараметрыВыполнения)
	...
	Иначе
		...
		ИначеЕсли ЗначениеЗаполнено(ОписаниеКоманды.ИмяФормы) Тогда
			...
			Если ОписаниеКоманды.ДополнительныеПараметры.Свойство("ШаблонВводаНаОсновании") Тогда
				бит_ОбщегоНазначенияКлиент.ЗаполнитьПоШаблонуВводаНаОснованииИОткрытьФорму(ПараметрыВыполнения, ПараметрыФормы);
			Иначе
				ОткрытьФорму(ОписаниеКоманды.ИмяФормы, ПараметрыФормы, ПараметрыВыполнения.Форма, Истина);
			КонецЕсли;
