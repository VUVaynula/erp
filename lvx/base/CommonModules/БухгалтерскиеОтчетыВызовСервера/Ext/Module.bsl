...
Процедура УстановитьНастройкиПоУмолчанию(ФормаОтчета) Экспорт
	...
	бит_БухгалтерскиеОтчеты.УстановитьНастройкиПоУмолчанию(ФормаОтчета);
...
Процедура ОбработкаПроверкиЗаполнения(ОтчетОбъект, Отказ, Проверки = Неопределено) Экспорт
	...
	Если Проверки.Свойство("СписокВидовСубконто") И Проверки.СписокВидовСубконто Тогда
		...
		МаксКоличествоСубконто = бит_БухгалтерскиеОтчетыВызовСервера.МаксимальноеКоличествоСубконтоОтчета(ОтчетОбъект);
		// бит_Финанс изменения кода. Конец.
...
//-- НЕ УТ
	...
	// бит_Финанс изменения кода. Начало.
	бит_БухгалтерскиеОтчеты.ИнициализацияФормыОтчета(Отчет, РеквизитыФормы, Форма);
	// бит_Финанс изменения кода. Конец.
...
Процедура ДобавитьОтборПоОрганизации(ПараметрыОтчета, КомпоновщикНастроек, ИмяОбъектаДанных = "РегистрБухгалтерии.Хозрасчетный", ВПользовательскиеНастройки = Истина) Экспорт
	...
	КонецЦикла;
	// бит_Финанс Изменения кода. Начало:
	бит_БухгалтерскиеОтчетыВызовСервера.ДополнитьСписокОрганизаций(СписокДоступныхОрганизаций, ИмяОбъектаДанных);
	// бит_Финанс Изменения кода. Конец.
