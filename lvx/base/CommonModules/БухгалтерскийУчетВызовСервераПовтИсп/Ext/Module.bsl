...
Функция ПолучитьСвойстваСчета(Знач Счет) Экспорт
	...
	Если ТипЗнч(Счет) = Тип("ПланСчетовСсылка.бит_Бюджетирование") ИЛИ ТипЗнч(Счет) = Тип("ПланСчетовСсылка.бит_Дополнительный_1")
		ИЛИ ТипЗнч(Счет) = Тип("ПланСчетовСсылка.бит_Дополнительный_2") ИЛИ ТипЗнч(Счет) = Тип("ПланСчетовСсылка.бит_Дополнительный_3")
		ИЛИ ТипЗнч(Счет) = Тип("ПланСчетовСсылка.бит_Дополнительный_4") ИЛИ ТипЗнч(Счет) = Тип("ПланСчетовСсылка.бит_Дополнительный_5") Тогда
