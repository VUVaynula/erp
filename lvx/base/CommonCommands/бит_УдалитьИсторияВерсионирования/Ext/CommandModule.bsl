...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПараметрыФормы.Вставить("ЗапрещеноРедактировать", ПараметрыВыполненияКоманды.Источник.ТолькоПросмотр);
	
	СписокВерсий = ОткрытьФорму("РегистрСведений.бит_УдалитьВерсииОбъектов.Форма.ФормаХранимыхВерсий", ПараметрыФормы,
