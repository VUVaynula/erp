...
//
Процедура ЗаписатьРучноеРазмещениеЭтапаВГрафике(ЗаказНаПроизводство, Этап, ГрафикПроизводства) Экспорт
...
Процедура ОчиститьГрафикИЗагрузкуПартии(Партии) Экспорт
	...
	Если ТипЗнч(Партии) = Тип("ТаблицаЗначений") И Партии.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
