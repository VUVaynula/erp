...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	КраткаяИнформацияПоОбмену   = "(бит) Обмен ERP ЗУП";
	ПодробнаяИнформацияПоОбмену = "ПланОбмена.бит_ОбменERP_ЗУП.Форма.ПодробнаяИнформация";
	...
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника                     = НСтр("ru = 'Настройки (бит) Обмен ERP ЗУП';
