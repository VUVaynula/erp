...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СтрТип") Тогда
		...
		ТекстЗапроса = Справочники.бит_ВидыФормСбораДанных.ПодготовитьТекстЗапросаДляВыгрузки(Параметры.СтрТип);
...
Процедура ТаблицаОтборЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТекущаяСтрока.ВидСравнения = ВидСравнения.ВИерархии 
		ИЛИ ТекущаяСтрока.ВидСравнения = ВидСравнения.НеВИерархии Тогда
...
&НаКлиенте
Процедура ТаблицаОтборЗначениеИзменениеТекстаРедактирования(Элемент, Текст, СтандартнаяОбработка)
...
Процедура ЗаполнитьКэшЗначений()
	...
	КэшЗначений.Вставить("ТекущаяИнформационнаяБаза", Справочники.бит_мпд_ВидыИнформационныхБаз.ТекущаяИнформационнаяБаза);
...
Процедура ОткрытьФормуПолейПостроителя(ИмяТабЧасти, ИмяПоля, Режим)
	...
	ПараметрыФормы.Вставить("ВидИнформационнойБазы",       КэшЗначений.ТекущаяИнформационнаяБаза);
