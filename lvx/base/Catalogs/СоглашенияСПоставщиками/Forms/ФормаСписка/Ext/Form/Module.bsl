...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастройкиВизирования = бит_ВизированиеСервер.НастройкиОбъектаВизирования("Справочник.СоглашенияСПоставщиками");
	Если НастройкиВизирования.ИспользоватьВизирование Тогда
		Элементы.КоманднаяПанельГруппаУстановитьСтатус.Видимость = Ложь;
	Иначе
		Элементы.КоманднаяПанельГруппаУстановитьСтатус.Видимость = Истина;
	КонецЕсли;
