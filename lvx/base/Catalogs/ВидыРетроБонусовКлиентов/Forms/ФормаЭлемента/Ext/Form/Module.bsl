...
Процедура ПоказательТоваровПриИзменении(Элемент)
	...
	Если (Объект.ПоказательТоваров <> ПредопределенноеЗначение("Перечисление.ЦелевыеПоказателиРетроБонусовПоТоварам.НеИспользуется")
		  И Объект.ПоказательТоваров <> ПредопределенноеЗначение("Перечисление.ЦелевыеПоказателиРетроБонусовПоТоварам.Сумма")) Тогда
