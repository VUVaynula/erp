...
Процедура ОбновитьДерево()
	...
	ЭлементРеквизиты = СоздатьЭлементДерева(КоллекцияЭлементов, 
		"Реквизиты", "Реквизиты", "Реквизиты", БиблиотекаКартинок.бит_Реквизиты, Истина);
	...
	Для каждого СтрокаТаблицы Из МассивСтрок Цикл
	     ...
	     СоздатьЭлементДерева(КоллекцияРеквизиты, СтрокаТаблицы.Имя, 
		 	"Реквизит", СтрокаТаблицы.КлючСвязи, БиблиотекаКартинок.бит_Реквизит, Ложь, ЕстьСсылки);
	...
	ЭлементТабЧасти = СоздатьЭлементДерева(КоллекцияЭлементов, 
		"ТабличныеЧасти", "ТабличныеЧасти", "ТабличныеЧасти", БиблиотекаКартинок.бит_ТабличнаяЧасть, Истина);
	...
	Для каждого СтрТабЧасть Из МассивТабЧасти Цикл
		...
		ЭлементТабЧасть = СоздатьЭлементДерева(КоллекцияТабЧасти, СтрТабЧасть.Имя, 
			"ТабличнаяЧасть", СтрТабЧасть.КлючСвязи, БиблиотекаКартинок.бит_ТабличнаяЧасть, Ложь, ЕстьСсылки);
		...
		Для каждого СтрокаТаблицы Из МассивСтрок Цикл
			...
			СоздатьЭлементДерева(КоллекцияТабЧасть, СтрокаТаблицы.Имя, "РеквизитТабличнойЧасти", 
				СтрокаТаблицы.КлючСвязи, БиблиотекаКартинок.бит_Реквизит, Ложь, ЕстьСсылки);
...
Процедура ДобавитьСтрокуРеквизит()
	...
	Если ЭлРеквизиты <> Неопределено Тогда
...
Процедура ОжиданиеАктивизацииСтрокиДерева()
	...
	Если ТекущаяСтрока <> Неопределено Тогда
		...
		Для каждого СтрокаТаблицы Из МассивСтрок Цикл
			...
			Если Свойства_СтрТип <> "ТабличнаяЧасть" Тогда				
				Свойства_Тип = бит_ОбщегоНазначенияКлиентСервер.ПолучитьОписаниеИзСтроки(Свойства_СтрТип,,
		...
		Для каждого Элемент Из СписокЭлементыПанели Цикл
			...
			ИначеЕсли ЭтоТабЧасть Тогда
				...
				Если ИмяРеквФормы = "Свойства_Имя" ИЛИ ИмяРеквФормы = "Свойства_Синоним" Тогда					 
