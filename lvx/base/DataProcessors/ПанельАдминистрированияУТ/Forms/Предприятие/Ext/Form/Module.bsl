...
Функция ПриИзмененииРеквизитаСервер(ИмяЭлемента)
    ...
    // бит_Финанс изменение кода. Начало. 25.03.2014{{
	Если ВРег(ИмяЭлемента) = ВРег("ВалютаУправленческогоУчета") Тогда	
		ТиповаяВалУпр = Константы.ВалютаУправленческогоУчета.Получить();
		Константы.бит_ВалютаУправленческогоУчета.Установить(ТиповаяВалУпр);	
	КонецЕсли; 
	// бит_Финанс изменение кода. Конец. 25.03.2014}}
