...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИсточникВыбора.ИмяФормы = "Обработка.бит_ОбеспечениеПотребностей.Форма.ФормаВыбораУпаковкиЕдиницы" Тогда
...
Процедура ФильтрУровеньЗапасаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("Обработка.бит_ОбеспечениеПотребностей.Форма.ФормаВыбораУровняЗапаса",
...
Процедура ЗапасыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Форма.Элемент.Запасы.Выбор");
...
Процедура ЗапасыПриАктивизацииСтроки(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.Запасы.ПриАктивизацииСтроки");
...
Процедура ОтметкаЗапасыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.ОтметкаЗапасы.ПриИзменении");
...
Процедура КЗаказуЗапасыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.КЗаказуЗапасы.ПриИзменении");
...
Процедура СпособОбеспеченияЗапасыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.СпособОбеспеченияЗапасы.ПриИзменении");
...
Процедура ИсточникОбеспеченияЗапасыНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Форма.Элемент.ИсточникОбеспеченияЗапасы.НачалоВыбора");
	...
	СтандартнаяОбработка = Ложь;
	ОткрытьФорму("Обработка.бит_ОбеспечениеПотребностей.Форма.ФормаВыбораИсточникаОбеспечения", ПараметрыФормы, ЭтаФорма, УникальныйИдентификатор);
...
Процедура ДатаПоставкиЗапасыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.ДатаПоставкиЗапасы.ПриИзменении");
...
Процедура ЗаказыКОбеспечениюПриАктивизацииСтроки(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.ЗаказыКОбеспечению.ПриАктивизацииСтроки");
...
Процедура ОтметкаЗаказыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.ОтметкаЗаказы.ПриИзменении");
	...
	// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [08.01.2026 14:36:33] +        
	Если ЗначениеЗаполнено(Поставка.ЗаказКлиента) Тогда              
		СтрокиПоКлючу = Объект.ЗаказыКОбеспечению.НайтиСтроки(Новый Структура("ЗаказКлиента", Поставка.ЗаказКлиента));
		Для каждого стр из СтрокиПоКлючу Цикл
			стр.Отметка = Поставка.Отметка;                        
			СоответствиеСтрок = ПересчитатьОкруглениеКлиент(стр, Ложь);
			ОтобразитьРасчитанноеОкругление(стр, Ложь);     
		КонецЦикла;
	КонецЕсли;
	// }}ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [08.01.2026 14:36:33] -
...
Процедура КЗаказуЗаказыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.КЗаказуЗаказы.ПриИзменении");
...
Процедура СпособОбеспеченияЗаказыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.СпособОбеспеченияЗаказы.ПриИзменении");
...
Процедура ИсточникОбеспеченияЗаказыНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Форма.Элемент.ИсточникОбеспеченияЗаказы.НачалоВыбора");
...
Процедура ДатаПоставкиЗаказыПриИзменении(Элемент)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Элемент.ДатаПоставкиЗаказы.ПриИзменении");
...
Процедура ПредварительныйПросмотрВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ПредварительныйПросмотрКЗаказу"
		...
		ОткрытьФорму("Обработка.бит_ОбеспечениеПотребностей.Форма.ФормаРедактированияКоличества", ПараметрыДляФормыРедактирования,,,,,ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура Назад(Команда)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Команда.Назад");
...
Процедура Далее(Команда)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Команда.Далее");
...
Процедура НастроитьПоддержаниеЗапаса(Команда)
	...
	ПараметрыФормы = Новый Структура("Отбор, Источник", ПараметрыФормыОтбор, "бит_ОбеспечениеПотребностей");
...
Процедура ЗаполнитьДатуПоставки(Команда)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Форма.Команда.ЗаполнитьДатуПоставки");
...
Функция ПолучениеТаблицыСпособовОбеспеченияВФоне()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.бит_ОбеспечениеПотребностей.ТаблицаСпособовОбеспечения",
...
Функция ПолучениеТаблицыЗапасовВФоне()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.бит_ОбеспечениеПотребностей.ТаблицаЗапасы",
		ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ПолучениеТаблицыЗаказовКОбеспечениюВФоне()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.бит_ОбеспечениеПотребностей.ТаблицаПотребностейПоЗаказамИОстатков",
		ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ФормированиеДереваЗаказовВФоне()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.бит_ОбеспечениеПотребностей.СформироватьДеревоЗаказов",
		ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ФормированиеЗаказовВФоне()
	...
	Поля = Обработки.бит_ОбеспечениеПотребностей.ПоляТаблицыЗаказы(СекцииДляВыгрузки);
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.бит_ОбеспечениеПотребностей.СформироватьЗаказы",
		ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция УдалениеЗаказовВФоне()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.бит_ОбеспечениеПотребностей.УдалитьЗаказы",
		ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ДанныеЗаполненияСтрокиТаблицыСпособовОбеспечения(Ссылка)
	...
	Обработки.бит_ОбеспечениеПотребностей.ТаблицаСпособовОбеспечения(ПараметрыПроцедуры, Адрес);
...
Процедура РассчитатьСтрокуТаблицыЗапасы(ИдентификаторСтроки, Отбор)
	...
	Обработки.бит_ОбеспечениеПотребностей.ТаблицаЗапасы(
	...
	Если Таблица.Количество() > 0 Тогда
		...
		РезультатРасчета = Обработки.бит_ОбеспечениеПотребностей.МинимальныйИМаксимальныйЗапасы(СтрокаЗапасы);
		ЗаполнитьЗначенияСвойств(СтрокаЗапасы, РезультатРасчета);
	
		РезультатРасчета = Обработки.бит_ОбеспечениеПотребностей.КоличествоКЗаказуДляПоддержанияЗапаса(СтрокаЗапасы);
		ЗаполнитьЗначенияСвойств(СтрокаЗапасы, РезультатРасчета);
	
		РезультатРасчета = Обработки.бит_ОбеспечениеПотребностей.УровеньЗапасаИКартинкаСменитьМетод(СтрокаЗапасы);
		ЗаполнитьЗначенияСвойств(СтрокаЗапасы, РезультатРасчета);
...
Процедура РассчитатьСтрокуТаблицыЗаказыКОбеспечению(ИдентификаторСтроки, Отбор)
	...
	Обработки.бит_ОбеспечениеПотребностей.ТаблицаПотребностейПоЗаказамИОстатков(
		Новый Структура("ТипОтбора,Отбор", "ОтборПоЗначениям", Отбор),
		АдресХранилища);
	...
	Если Таблица.Количество() > 0 Тогда
		...
		РезультатРасчета = Обработки.бит_ОбеспечениеПотребностей.КоличествоКЗаказуДляОбеспеченияЗаказов(СтрокаЗаказы);
...
Процедура ЗаказыПриАктивизацииСтрокиОбработчикОжидания()
	...
	Иначе
		// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 20:00:05] +        
		// все что тут вынесем в отдельную процедуру добавив свою логику
		//Если ЗначениеЗаполнено(строка.ЗаказКлиента) Тогда
		//	СтрокиПоКлючу = Объект.ЗаказыКОбеспечению.НайтиСтроки(Новый Структура("ЗаказКлиента", строка.ЗаказКлиента));
		//	Для каждого стр из СтрокиПоКлючу Цикл
		//		стр.Отметка = Строка.Отметка;                        
		//		бит_ЗаказыПриАктивизацииСтрокиОбработчикОжидания(Строка);
		//	КонецЦикла;
		//Иначе
			бит_ЗаказыПриАктивизацииСтрокиОбработчикОжидания(Строка);	
		//КонецЕсли;
...
&НаКлиенте
Процедура бит_ЗаказыПриАктивизацииСтрокиОбработчикОжидания(Строка)
...
Процедура ОткрытьМетодОбеспечения(ИмяТаблицы)
	...
	ОткрытьФорму("Обработка.бит_ОбеспечениеПотребностей.Форма.ФормаРедактированияПараметровОбеспечения", ПараметрыФормы, ЭтаФорма, УникальныйИдентификатор);
...
Функция ДалееКШагуЗаказы(Результат)
	...
	Если Не ИспользоватьЗаказыПоставщикам Тогда
		...
		КонецЕсли;
	КонецЕсли;
	// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:33:19] +        
	бит_ДополнитьЗаказомКлиента(Таблица);
	// }}ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:33:19] -
	...
	// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:36:10] +        
	ПроставитьОтметкиПоЗаказамКлиента();
	// }}ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:36:10] -
...
&НаСервере
Процедура бит_ДополнитьЗаказомКлиента(Таблица)
	// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:34:28] +        
	ТекстКолонок = "";
	ВсегоКолонок = Таблица.Колонки.Количество() - 1;
	Для сч = 0 по ВсегоКолонок Цикл                                                
		колонка = Таблица.Колонки[сч];
		ТекстКолонок = ТекстКолонок + " " + "%1." + колонка.Имя + " КАК " + колонка.Имя + ?(сч = ВсегоКолонок, "", "," + Символы.ПС);
	КонецЦикла; 
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = Новый МенеджерВременныхТаблиц;  
	Запрос.УстановитьПараметр("таблица", Таблица);
	Запрос.Текст = "ВЫБРАТЬ 
				   | " + СтрШаблон(ТекстКолонок, "таблица") + "
				   |ПОМЕСТИТЬ таблица 
				   |ИЗ
				   | &таблица КАК Таблица;
				   |
				   |/////////////////////////////////////// Добавим автономер, чтобы проще было потом объединять строки
				   |ВЫБРАТЬ
	...
	// выберем строки с которыми работаем
	//Запрос.Текст = "ВЫБРАТЬ
	//               |	втБаза.Автономер КАК Автономер,
	//               |	втБаза.Номенклатура КАК Номенклатура,
	//               |	втБаза.Характеристика КАК Характеристика,
	//               |	втБаза.Заказ КАК Заказ,
	//               |	втБаза.Назначение.Заказ КАК ЗаказНаПеремещениеОбщий
	//               |ПОМЕСТИТЬ втРабочиеСтроки
	//               |ИЗ
	//               |	втБаза КАК втБаза
	//               |ГДЕ
	//               |	втБаза.Заказ ССЫЛКА Документ.ЗаказНаПеремещение
	//               |	И втБаза.Назначение <> ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка)
	//               |	И втБаза.Назначение.Заказ ССЫЛКА Документ.ЗаказНаПеремещение
	//			   |	И втБаза.СпособОбеспечения.ТипОбеспечения = Значение(Перечисление.ТипыОбеспечения.Производство)
	//               |;
	//               |
	//               |////////////////////////////////////////////////////////////////////////////////
	//               |ВЫБРАТЬ
	//               |	втРабочиеСтроки.Автономер КАК Автономер,
	//               |	ЗаказНаПеремещениеТовары.Назначение.Заказ КАК ЗаказКлиента
	//               |ПОМЕСТИТЬ втЗаказыКлиентов
	//               |ИЗ
	//               |	втРабочиеСтроки КАК втРабочиеСтроки
	//               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаказНаПеремещение.Товары КАК ЗаказНаПеремещениеТовары
	//               |		ПО втРабочиеСтроки.Номенклатура = ЗаказНаПеремещениеТовары.Номенклатура
	//               |			И втРабочиеСтроки.Характеристика = ЗаказНаПеремещениеТовары.Характеристика
	//               |			И втРабочиеСтроки.ЗаказНаПеремещениеОбщий = ЗаказНаПеремещениеТовары.Ссылка
	//               |ГДЕ
	//               |	НЕ ЗаказНаПеремещениеТовары.Отменено
	//               |	И ЗаказНаПеремещениеТовары.Назначение <> ЗНАЧЕНИЕ(Справочник.назначения.ПустаяСсылка)
	//               |	И ЗаказНаПеремещениеТовары.Назначение.Заказ ССЫЛКА Документ.ЗаказКлиента
	//               |;
	//               |
	//               |////////////////////////////////////////////////////////////////////////////////
	//               |УНИЧТОЖИТЬ втРабочиеСтроки"; 
	Запрос.Текст = "ВЫБРАТЬ
	               |	втБаза.Автономер КАК Автономер,
	               |	втБаза.Номенклатура КАК Номенклатура,
	               |	втБаза.Характеристика КАК Характеристика,
	               ...
	               |ВЫБРАТЬ
	               |	втРабочиеСтроки.Автономер КАК Автономер,
	               |	ЗаказНаПеремещениеТоварыОбщие.Назначение.Заказ КАК ЗаказКлиента
	               |ПОМЕСТИТЬ втЗаказыКлиентов
	               |ИЗ
	               |	втРабочиеСтроки КАК втРабочиеСтроки
	               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаказНаПеремещение.Товары КАК ЗаказНаПеремещениеТовары
	               |			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаказНаПеремещение.Товары КАК ЗаказНаПеремещениеТоварыОбщие
	               |			ПО ЗаказНаПеремещениеТовары.Номенклатура = ЗаказНаПеремещениеТоварыОбщие.Номенклатура
	               |				И ЗаказНаПеремещениеТовары.Характеристика = ЗаказНаПеремещениеТоварыОбщие.Характеристика
	               |				И ЗаказНаПеремещениеТовары.Назначение.Заказ = ЗаказНаПеремещениеТоварыОбщие.Ссылка
	               |		ПО втРабочиеСтроки.Номенклатура = ЗаказНаПеремещениеТовары.Номенклатура
	               |			И втРабочиеСтроки.Характеристика = ЗаказНаПеремещениеТовары.Характеристика
	               |			И втРабочиеСтроки.ЗаказНаПеремещениеОбщий = ЗаказНаПеремещениеТовары.Ссылка
	               |ГДЕ
	               |	НЕ ЗаказНаПеремещениеТовары.Отменено
	               |	И ЗаказНаПеремещениеТовары.Назначение <> ЗНАЧЕНИЕ(Справочник.назначения.ПустаяСсылка)
	               |	И ЗаказНаПеремещениеТовары.Назначение.Заказ ССЫЛКА Документ.ЗаказНаПеремещение
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |УНИЧТОЖИТЬ втРабочиеСтроки";
	...
	Запрос.Текст = "ВЫБРАТЬ 
				   ...
				   |  втБаза.Автономер = втЗаказыКлиентов.Автономер
				   |ГДЕ
				   |	втЗаказыКлиентов.Автономер ЕСТЬ NULL";
	Таблица = Запрос.Выполнить().Выгрузить();
	// }}ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:34:28] -
КонецПроцедуры  

&НаСервере
Процедура ПроставитьОтметкиПоЗаказамКлиента()
	// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:37:15] +        
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |ВЫБРАТЬ
	                      |	вт.ЗаказКлиента КАК ЗаказКлиента,
	                      |	МАКСИМУМ(вт.Отметка) КАК Отметка
	                      |ИЗ
	                      |	вт КАК вт
	                      |ГДЕ
	                      ...
	                      |СГРУППИРОВАТЬ ПО
	                      |	вт.ЗаказКлиента");
	Запрос.УстановитьПараметр("вт", Объект.ЗаказыКОбеспечению.Выгрузить(, "ЗаказКлиента, Отметка"));
	ТЗ = Запрос.Выполнить().Выгрузить();
	Для каждого стр из ТЗ Цикл
		СтрокиПоКлючу = Объект.ЗаказыКОбеспечению.НайтиСтроки(Новый Структура("ЗаказКлиента", стр.ЗаказКлиента));	
		Для каждого ТекСтр из СтрокиПоКлючу Цикл
			ТекСтр.Отметка = стр.Отметка;
		КонецЦикла;
	КонецЦикла;
	// }}ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 18:37:15] -
КонецПроцедуры
...
Процедура СохранитьНастройки()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("Обработка.Обработкабит_ОбеспечениеПотребностей", "Основная", Настройки);
...
Процедура ВосстановитьНастройки()
	...
	ЗначениеНастроек = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("Обработка.Обработкабит_ОбеспечениеПотребностей", "Основная");
...
Процедура ОбработатьДоступностьТиповОбеспечения(ПараметрОтбор)
	...
	ДоступныеТипы = Обработки.бит_ОбеспечениеПотребностей.ДоступныеТипыОбеспечения();
...
Процедура ЗаполнитьИсточникОбеспечения(МассивТиповОбеспечения)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.бит_ОбеспечениеПотребностей.Форма.Форма.Команда.ЗаполнитьИсточникОбеспечения");
...
Процедура ВыбратьУпаковкуКлиент(ИмяТаблицы)
	...
	ОткрытьФорму("Обработка.бит_ОбеспечениеПотребностей.Форма.ФормаВыбораУпаковкиЕдиницы", ПараметрыФормы, ЭтаФорма, УникальныйИдентификатор);
...
&НаКлиенте
Процедура ПредварительныйПросмотрКЗаказуПриИзменении(Элемент)
	// {{ПервыйБИТ ЛистТребований [ЛТ6.5]  [VUVaynula@1cbit.ru] [07.01.2026 12:36:19] +        
