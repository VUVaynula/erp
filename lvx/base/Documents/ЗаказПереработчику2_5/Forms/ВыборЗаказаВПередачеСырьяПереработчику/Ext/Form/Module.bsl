...
Процедура ЗаполнитьСписокРаспоряжений()
	...
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).Организация = &Организация
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).Валюта = &Валюта
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).Контрагент = &Контрагент
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).Договор = &Договор
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).Партнер = &Партнер
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).Сделка = &Сделка
	|						И ВЫРАЗИТЬ(Распоряжение КАК Документ.ЗаказПереработчику2_5).ВернутьМногооборотнуюТару = &ВернутьМногооборотнуюТару
	|						И (Склад = &Склад
	...
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).Организация = &Организация
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).Валюта = &Валюта
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).Контрагент = &Контрагент
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).Договор = &Договор
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).Партнер = &Партнер
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).Сделка = &Сделка
	|			И ВЫРАЗИТЬ(РаспоряженияДвижения.ЗаказКлиента КАК Документ.ЗаказПереработчику2_5).ВернутьМногооборотнуюТару = &ВернутьМногооборотнуюТару
