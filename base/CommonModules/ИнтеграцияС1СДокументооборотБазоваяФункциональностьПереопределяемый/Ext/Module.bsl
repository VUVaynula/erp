...
Процедура ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка) Экспорт
	...
	Если ИмяФормы = Метаданные.Справочники.ВидыРетроБонусовКлиентов.Формы.ФормаЭлемента.ПолноеИмя()
			...
			// Тогда
			ИЛИ ИмяФормы = "Документ.бит_БюджетнаяОперация.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_БюджетнаяОперация.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_БюджетнаяОперация.Форма.ФормаСпискаДокументов"
			ИЛИ ИмяФормы = "Документ.бит_ДополнительныеУсловияПоДоговору.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_ДополнительныеУсловияПоДоговору.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_ДополнительныеУсловияПоДоговору.Форма.ФормаСпискаДокументов"
			ИЛИ ИмяФормы = "Документ.бит_кзн_ЗаявкаНаРасходованиеСредств.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_кзн_ЗаявкаНаРасходованиеСредств.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_кзн_ЗаявкаНаРасходованиеСредств.Форма.ФормаСпискаДокументов"
			ИЛИ ИмяФормы = "Документ.бит_кзн_ПлатежнаяПозиция.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_кзн_ПлатежнаяПозиция.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_кзн_ПлатежнаяПозиция.Форма.ФормаСпискаДокументов"
			ИЛИ ИмяФормы = "Документ.бит_кзн_РеестрПлатежей.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_кзн_РеестрПлатежей.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_кзн_РеестрПлатежей.Форма.ФормаСпискаДокументов"
			ИЛИ ИмяФормы = "Документ.бит_пз_ЗаявкаНаЗатраты.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_пз_ЗаявкаНаЗатраты.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_пз_ЗаявкаНаЗатраты.Форма.ФормаСпискаДокументов"
			ИЛИ ИмяФормы = "Документ.бит_ФормаВводаБюджета.Форма.ФормаДокумента"
			ИЛИ ИмяФормы = "Документ.бит_ФормаВводаБюджета.Форма.ФормаСписка"
			ИЛИ ИмяФормы = "Документ.бит_ФормаВводаБюджета.Форма.ФормаСпискаДокументов" Тогда
