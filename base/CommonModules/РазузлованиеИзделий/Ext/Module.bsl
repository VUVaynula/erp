...
Процедура ПодобратьАналогиПолуфабрикатов(СтрокиПотребности, ТаблицаМатериалов, РезервыПФ)
	...
	ТаблицаТоваров.Колонки.Добавить("Этап", Новый ОписаниеТипов("ДокументСсылка.ЭтапПроизводства2_2"));
	
	Аналоги = АналогиМатериалов.ПолучитьТаблицуЗаменыДляФормированияЭтапов(ТаблицаТоваров, РезервыПФ, Ложь);
