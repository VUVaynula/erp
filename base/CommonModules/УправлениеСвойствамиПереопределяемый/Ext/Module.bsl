...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	Справочники.бит_ВнутренниеДокументы.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
...
Процедура ЗаполнитьНаборыСвойствОбъекта(Знач Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	// бит_Финанс изменения кода. Начало.
	ИначеЕсли ТипСсылки = Тип("СправочникСсылка.бит_ВнутренниеДокументы") Тогда
        бит_ЗаполнитьНаборСвойствПоВидуВнутреннегоДокумента(
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Объекты расчетов';
		|en = 'AR/AP objects'", КодыЯзыков); // @НСтр-1
...
// бит_Финанс изменения кода. Начало.
Процедура бит_ЗаполнитьНаборСвойствПоВидуВнутреннегоДокумента(ВнутреннийДокумент, ТипСсылки, НаборыСвойств)
	
	 Если ТипЗнч(ВнутреннийДокумент) = ТипСсылки Тогда
        ВнутреннийДокумент = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
            					ВнутреннийДокумент, "ВидДокумента");
    КонецЕсли;
	
	ВидДокумента = ВнутреннийДокумент.ВидДокумента;
	Если ВидДокумента <> Неопределено Тогда
		Строка = НаборыСвойств.Добавить();
		Строка.Набор = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВидДокумента, "НаборСвойств");
	КонецЕсли;
