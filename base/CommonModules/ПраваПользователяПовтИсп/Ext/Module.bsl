...
Функция ИзменениеИндивидуальныхСоглашений(Пользователь = Неопределено) Экспорт
	...
	Возврат Пользователи.РолиДоступны("ДобавлениеИзменениеИндивидуальныхСоглашенийСКлиентами, бит_рлс_ИсполнительДоговоров", Пользователь, Ложь);
...
Функция ИзменениеТиповыхСоглашений(Пользователь = Неопределено) Экспорт
	...
	Возврат Пользователи.РолиДоступны("ДобавлениеИзменениеТиповыхСоглашенийСКлиентами,бит_рлс_ИсполнительДоговоров", Пользователь, Ложь);
	// бит_Финанс изменения кода. Конец.
КонецФункции
