...
//	ВыбранноеПолеКомпоновкиДанных - выбранное поле.
//
Функция ВыбранноеПоле(ЭлементСтруктуры, Поле, ВключаяВложенныеПоля = Ложь) Экспорт
...
//
// Возвращаемое значение:
//	СтруктураНастроекКомпоновкиДанных - последний элемент структуры.
//
...
//
Функция ИспользуетсяОтбор(Элементы, Знач ПолеКомпоновки, ВключаяВложенныеПоля = Ложь)
...
//
Функция ИспользуемыеОтборыРавны(ИсточникОтбор, ЭлементСравненияОтбор)
