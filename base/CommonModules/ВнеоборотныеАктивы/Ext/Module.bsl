...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'OB entry: sub-assets and components of depreciation'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Перемещение НМА';
		|en = 'Transfer intangible assets'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Asset activity record register'", КодыЯзыков); // @НСтр-1
