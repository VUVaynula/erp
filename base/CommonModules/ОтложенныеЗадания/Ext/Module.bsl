...
Функция ОчередиЗаданий() Экспорт
	...
	Параметры.ИмяМетода                   = "РегистрыСведений.ЗаданияКРасчетуСтруктурыЗаказаПриИзмененииПриоритета.ЗарегистрироватьЗадания";
			...
			Если УдалитьЗапись Тогда
				...
				Исключение
					...
					ШаблонОшибки = НСтр("ru = 'Не удалось удалить запись регистра ""%1"":
											   ...
											   |по причине:
											   |%3';
											   |en = 'Cannot delete the ""%1"" register record:
											   |%2
											   |
											   |Reason:
											   |%3'");
