...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Если НЕ ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПодсистемы") Тогда
		...
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
			...
			|en = 'Business units'", КодыЯзыков); // @НСтр-1
		...
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
			...
			|en = 'Document kinds of persons'", КодыЯзыков); // @НСтр-1
		...
		МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
			...
			|en = 'Cash deposit into personal accounts'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Reconcile opening balances by warehouses'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Post payroll expenses to accounting'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Accrued payroll kinds'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Cost centers'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Fixed asset impairment documents'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'ЕГДС';
		|en = 'Cash-generating unit'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'WIP opening balances by production lots'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'WIP opening balances by business units'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Production overhead standards'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Product standard costs'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Technological processes'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Payment system contracts'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Electronic tickets and bookings'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Travel requests'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Ценовые группы';
		|en = 'Price groups'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Inventory assignment adjustment'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Routing operations'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Sub-assets'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Клиенты';
		|en = 'Customers'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(ДочернийНабор, "Наименование",
		"ru = 'Конкуренты';
		|en = 'Competitors'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Item batch'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Product characteristics'", КодыЯзыков); // @НСтр-1
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Инциденты';
		|en = 'Incidents'", КодыЯзыков); // @НСтр-1
	...
	Наименование = "ru = 'Инвентаризация объектов учета';
					|en = 'Инвентаризация объектов учета'"; // @НСтр
