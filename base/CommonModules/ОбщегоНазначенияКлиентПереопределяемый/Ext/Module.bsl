...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	бит_ОбщегоНазначенияКлиентПереопределяемый.ПередНачаломРаботыСистемы(Параметры.Отказ);
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	// бит_Финанс изменения кода. Начало.
	бит_ОбщегоНазначенияКлиентПереопределяемый.ПриНачалеРаботыСистемы(ПараметрыРаботыКлиента);
	// бит_Финанс изменения кода. Конец.
