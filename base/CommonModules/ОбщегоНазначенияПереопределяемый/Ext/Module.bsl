...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("бит_*","бит_ПолныеПраваВызовСервера.ЗаполнитьПараметрыСеанса");	
...
Процедура ПриДобавленииИсключенийПоискаСсылок(ИсключенияПоискаСсылок) Экспорт
	...
	// бит_Финанс изменения кода. Начало.
	ИсключенияПоискаСсылок.Добавить(Метаданные.Справочники.бит_КлючиСценарийЦФО);
	ИсключенияПоискаСсылок.Добавить(Метаданные.Справочники.бит_КлючиДоступаЦФОСтатьиОборотов);
	ИсключенияПоискаСсылок.Добавить(Метаданные.Справочники.бит_ГруппыКлючейДоступаЦФОСтатьиОборотов);
	ИсключенияПоискаСсылок.Добавить(Метаданные.РегистрыСведений.бит_АналитикаСценарийЦФО);
	ИсключенияПоискаСсылок.Добавить(Метаданные.РегистрыСведений.бит_АналитикаЦФОСтатьяОборотов);
	// бит_Финанс изменения кода. Конец. 
