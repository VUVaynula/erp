...
Функция СведенияОбОрганизациях(Знач Организации)
	...
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		НСтр(
			...
			|en = 'Не задано имя справочника организаций'",
			ОбщегоНазначения.КодОсновногоЯзыка()),
		Контекст);
	...
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		СтрШаблон(
			НСтр(
				...
				|en = 'Не найден справочник организаций (имя: %1)'",
				ОбщегоНазначения.КодОсновногоЯзыка()),
			ИмяСправочника),
		Контекст);
	...
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		НСтр(
			...
			|en = 'Не задано имя реквизита для наименования организации'",
			ОбщегоНазначения.КодОсновногоЯзыка()),
		Контекст);
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		НСтр(
			...
			|en = 'Не задано имя реквизита для ИНН организации'",
			ОбщегоНазначения.КодОсновногоЯзыка()),
		Контекст);
	ОбщегоНазначенияКлиентСервер.Проверить(
		...
		НСтр(
			...
			|en = 'Не задано имя реквизита для КПП организации'",
			ОбщегоНазначения.КодОсновногоЯзыка()),
		Контекст);
...
Функция ПредставлениеПрикладногоРешения()
	...
	ВерсияПрикладногоРешения = бит_ОбщегоНазначения.МетаданныеВерсия();
