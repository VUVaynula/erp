...
//
// Возвращаемое значение:
//  Структура - структура данных уведомления, разделенная по разделам.
//
...
//
// Параметры:
//  СведениеОбУведомлении - Структура - см. тип возвращаемого значения модуля менеджера документа 
