...
Процедура ЗаписатьЛогНаСервереПриЗавершении(Отказ, ТекстПредупреждения) Экспорт
	...
	ТекстПредупреждения = НСтр("ru = 'Не до конца выполнена запись операций работы с подключаемым оборудованием.
								...
								|en = 'The operation record with peripherals was not fully executed.
								|To record all operations, press the ""Continue working"" button and then again finish the application operation.'");
...
Процедура СформироватьОписаниеОпераций(СистемаЛогирования)
	...
	ДобавитьОперацию(СистемаЛогирования, 0, "QRCodeOutputOnCustomerDisplay", НСтр("ru = 'Вывести QR код на дисплей покупателя';
																					|en = 'Вывести QR код на дисплей покупателя'"), "DeviceID, QRCodeValue, QRСodePicture", НСтр("ru = 'ИД устройства, Значение QR кода, Картинка QRКода';
																																												|en = 'ИД устройства, Значение QR кода, Картинка QRКода'"), "", "");
	...
	ДобавитьОперацию(СистемаЛогирования, 0, "Pay", НСтр("ru = 'Оплатить';
														|en = 'Pay'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																														|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																			|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "ReturnPayment", НСтр("ru = 'Вернуть платеж';
																	|en = 'Return the payment'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																		|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																							|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "CancelPayment", НСтр("ru = 'Отменить платеж';
																	|en = 'Cancel the payment'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																		|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																							|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "Authorisation", НСтр("ru = 'Преавторизация';
																	|en = 'Preauthorization'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																		|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																							|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "AuthConfirmation", НСтр("ru = 'Завершить преавторизацию';
																	|en = 'Finish preauthorization'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																					|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																										|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "CancelAuthorisation", НСтр("ru = 'Отменить преавторизацию';
																		|en = 'Cancel preauthorization'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																					|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																											|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "PayWithCashWithdrawal", НСтр("ru = 'Оплата с выдачей наличных';
																			|en = 'Оплата с выдачей наличных'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																						|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																												|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "PurchaseWithEnrollment", НСтр("ru = 'Покупка с зачислением';
																			|en = 'Покупка с зачислением'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																						|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																											|en = ', , Original parameters, Receipt text'"));
	...
	ДобавитьОперацию(СистемаЛогирования, 0, "PayCertificate", НСтр("ru = 'Оплатить сертификатом';
																	|en = 'Pay with a certificate'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																				|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																									|en = ', , Original parameters, Receipt text'"));
	ДобавитьОперацию(СистемаЛогирования, 0, "ReturnCertificate", НСтр("ru = 'Вернуть сертификатом';
																		|en = 'Return with a certificate'"), "DeviceID, OperationParameters, , ", НСтр("ru = 'ИД устройства, Входяшие параметры, ,';
																																				|en = 'ИД устройства, Входяшие параметры, ,'"), ", , OperationParameters, Slip", НСтр("ru = ', , Исходящие параметры, Текст квитанции';
																																																										|en = ', , Original parameters, Receipt text'"));
	...
	ДобавитьОперацию(СистемаЛогирования, 4000, "PayElectronicCertificate", НСтр("ru = 'Оплатить электронным сертификатом';
																				|en = 'Pay with digital certificate'"), "DeviceID, MerchantNumber, BasketID, ElectronicCertificateAmount, OwnFundsAmount, , , , , , ", НСтр("ru = 'ИД устройства, Номер мерчанта, Идентификатор корзины, Сумма электроного сертификата, Сумма собственных средств, , , , , ,';
																																																								|en = 'ИД устройства, Номер мерчанта, Идентификатор корзины, Сумма электроного сертификата, Сумма собственных средств, , , , , ,'"), ", , BasketID, , , CardNumber, ReceiptNumber, RRNCode, AuthorizationCode, OperationStatus, Slip", НСтр("ru = ', , Идентификатор корзины, , , Номер карты, Номер чека, Код RRN, Код авторизации, Статус операции, Текст квитанции';
	...
	ДобавитьОперацию(СистемаЛогирования, 4000, "ReturnElectronicCertificate", НСтр("ru = 'Вернуть электронным сертификатом';
																					|en = 'Return by digital certificate'"), "DeviceID, MerchantNumber, BasketID, ElectronicCertificateAmount, OwnFundsAmount, CardNumber, ReceiptNumber, RRNCode, , , ", НСтр("ru = 'ИД устройства, Номер мерчанта, Идентификатор корзины, Сумма электроного сертификата, Сумма собственных средств, Номер карты, Номер чека, Код RRN, , ,';
																																																																|en = 'ИД устройства, Номер мерчанта, Идентификатор корзины, Сумма электроного сертификата, Сумма собственных средств, Номер карты, Номер чека, Код RRN, , ,'"), ", , BasketID, , , CardNumber, ReceiptNumber, RRNCode, AuthorizationCode, OperationStatus, Slip", НСтр("ru = ', , Идентификатор корзины, , , Номер карты, Номер чека, Код RRN, Код авторизации, Статус операции, Текст квитанции';
																																																																																																																																		|en = ', , Cart ID, , , Card number, Receipt number, RRN Code, Authorization code, Transaction status, Receipt text'"));
