...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Создает новые элементы справочника ""Ставки НДС"" для типа налогообложения НДС ""Облагается НДС с межценовой разницы""
		...
		|en = 'Creates new ""VAT rates"" catalog items for the ""Subject to VAT from price difference""
		|and  ""Preferential VAT taxation on STS"" VAT taxation types.
		|Adds the ""Space activity"" VAT taxation type to the 0% rate.
		|Adds the ""Subject to VAT in EAEU country (not the Russian Federation)"" and ""Preferential VAT taxation on STS"" VAT taxation types to the ""Excluding VAT"" rate.
