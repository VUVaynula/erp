...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Если Объект.Ссылка.Пустая()
		...
		Объект.Статус                      = Перечисления.СтатусыСоглашенийСПоставщиками.НеСогласовано;
	КонецЕсли;
...
Функция бит_ДоступнаяКомандаУправленияСтатусом()
	...
	ИначеЕсли бит_ПраваДоступа.ПолучитьЗначениеДопПраваПользователя(Пользователи.ТекущийПользователь(), 
		...
		Если Объект.Статус = Перечисления.СтатусыСоглашенийСПоставщиками.Закрыто Тогда
			ДоступнаяКоманда.ИмяКоманды = "ОткрытьДоговор";
			ДоступнаяКоманда.Заголовок  = НСтр("ru = 'Открыть соглашение'; en = 'Open terms'");
		Иначе
			ДоступнаяКоманда.ИмяКоманды = "ЗакрытьДоговор";
			ДоступнаяКоманда.Заголовок  = НСтр("ru = 'Закрыть соглашение'; en = 'Close terms'");
		КонецЕсли;
	КонецЕсли;
...
Процедура бит_Подключаемый_КомандаУправленияСтатусомНажатие(Команда)
	...
	ИначеЕсли ДействиеСтатуса = "ЗакрытьДоговор" Тогда
		Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыСоглашенийСПоставщиками.Закрыто");
	ИначеЕсли ДействиеСтатуса = "ОткрытьДоговор" Тогда
		Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыСоглашенийСПоставщиками.НеСогласовано");
	КонецЕсли;
