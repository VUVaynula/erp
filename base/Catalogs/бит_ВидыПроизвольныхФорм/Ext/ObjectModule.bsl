...
Процедура ПроверитьДублиИмен(Отказ)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	ВидыПроизвольныхФорм.Ссылка КАК Ссылка
	               |ИЗ
	               |	Справочник.бит_ВидыПроизвольныхФорм КАК ВидыПроизвольныхФорм
	               |ГДЕ
	               |	ВидыПроизвольныхФорм.Имя = &Имя
	               |	И ВидыПроизвольныхФорм.Ссылка <> &Ссылка";
