...
Процедура ПередЗаписью(Отказ)
	...
	бит_ЗаполнитьРеквизитыБИТПоДаннымДоговора();
...
// Процедура заполянет реквизиты БИТ на основании данных договора.
//
// Параметры:
//
Процедура бит_ЗаполнитьРеквизитыБИТПоДаннымДоговора()

	Если Не ЗначениеЗаполнено(бит_ТипДоговора) Тогда
		
		Если ХарактерДоговора = ПредопределенноеЗначение("Перечисление.ХарактерыДоговоровФинансовыхИнструментов.КредитИлиЗайм") 
			И ТипДоговора = ПредопределенноеЗначение("Перечисление.ТипыДоговораКредитовИДепозитов.КредитВБанке") Тогда
			бит_ТипДоговора = ПредопределенноеЗначение("Справочник.бит_ТипыДоговоров.КредитыПолученные");
			
		ИначеЕсли ХарактерДоговора = ПредопределенноеЗначение("Перечисление.ХарактерыДоговоровФинансовыхИнструментов.КредитИлиЗайм") Тогда
			бит_ТипДоговора = ПредопределенноеЗначение("Справочник.бит_ТипыДоговоров.ЗаймыПолученные");
			
		ИначеЕсли ХарактерДоговора = ПредопределенноеЗначение("Перечисление.ХарактерыДоговоровФинансовыхИнструментов.ЗаймВыданный") Тогда
            бит_ТипДоговора = ПредопределенноеЗначение("Справочник.бит_ТипыДоговоров.ЗаймыВыданные");
		КонецЕсли;
				
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(бит_СуммаДоговора) Тогда	
		бит_СуммаДоговора = СуммаТраншей;			
	КонецЕсли;
	
КонецПроцедуры // бит_ЗаполнитьРеквизитыБИТПоДаннымДоговора()
