...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ПсевдоМета      = бит_РаботаСПроизвольнымиФормами.ЭмулироватьМетаданные(ВидФормыСбораДанных);
	ДанныеДокумента = Документы.бит_ФормаСбораДанных.ПодготовитьДанныеДокумента(Ссылка);
	...
	Документы.бит_ФормаСбораДанных.ЗаполнитьПриемникиПроформы(ЭтотОбъект);
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("СправочникСсылка.бит_ВидыФормСбораДанных") Тогда
		ВидФормыСбораДанных = ДанныеЗаполнения;		
