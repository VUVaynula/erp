...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПротоколЗаполнения") Тогда					
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ПротоколЗаполнения", 
			НСтр("ru='Протокол заполнения';en='Protocol'"), 
			ПолучитьПротоколЗаполненияДокумента(МассивОбъектов),, 
			"Документ.бит_му_КонсолидационныеКорректировки.МакетПротоколЗаполнения");
	КонецЕсли;
