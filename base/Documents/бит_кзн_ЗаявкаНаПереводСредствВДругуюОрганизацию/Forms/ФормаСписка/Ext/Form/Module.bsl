...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.Заголовок = НСтр("ru='Заявка на перевод денежных средств в другую организацию';
								|en='Application for transfer of funds to another organization'");
	
	МетаданныеОбъекта = Метаданные.Документы.бит_кзн_ЗаявкаНаПереводСредствВДругуюОрганизацию;
