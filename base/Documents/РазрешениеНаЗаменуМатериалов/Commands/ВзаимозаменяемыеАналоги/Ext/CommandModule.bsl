...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если Не ВводДоступен Тогда
		...
		ТекстСообщения = НСтр("ru = 'Создание взаимозаменяемых аналогов доступно только для режима ""Один на один"" или ""Набор на набор""';
								|en = 'You can create interchangeable substitutes only in ""One to one"" and ""Set to set"" modes'");
