...
Процедура ПереместитьДокументВОчереди(ТекущийЗаказ, Направление) Экспорт
	...
	Если Выборка.Следующий() Тогда
		...
		Попытка
			...
			Если ПриоритетИзменен Или ПолучитьФункциональнуюОпцию("ДинамическаяСтруктураЗаказовНаПроизводство") Тогда
				ОтложенныеЗадания.ОбработатьЗаданияОчереди(
						"ЗаданияКРасчетуСтруктурыЗаказаПриИзмененииПриоритета",
							Новый Структура("ЗаказНаПроизводство", ТекущийЗаказ));
			КонецЕсли;
			...
			Если ВыборкаОчередь.Следующий() Тогда
				...
				Попытка
					...
					Если ПриоритетИзменен Или ПолучитьФункциональнуюОпцию("ДинамическаяСтруктураЗаказовНаПроизводство") Тогда
						ОтложенныеЗадания.ОбработатьЗаданияОчереди(
								"ЗаданияКРасчетуСтруктурыЗаказаПриИзмененииПриоритета",
									Новый Структура("ЗаказНаПроизводство", Заказ));
					КонецЕсли;
