...
Процедура НастроитьАвтоматическиСейчас(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("НастроитьАвтоматическиСейчасПослеАвтонастройки", ЭтотОбъект);
...
&НаКлиенте
Процедура НастроитьАвтоматическиСейчасПослеАвтонастройки(Результат, ДополнительныеПараметры) Экспорт
	...
	Если РезультатНастройки = Истина Тогда
		ОбновитьНастройкиОбменаОрганизации();
		ПоказатьПредупреждение(, НСтр("ru = 'Автоматическая настройка успешно завершена.';
