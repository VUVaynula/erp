...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Элементы.ПредставлениеУведомления.ТолькоПросмотр 
...
Процедура ВыгрузкаВФоне()
	...
	Если НЕ РезультатВыполнения.ЗаданиеВыполнено Тогда
		...
		ПараметрыОжидания.ТекстСообщения = НСтр("ru = 'Выполняется формирование доплонительных файлов выгрузки';
												|en = 'Выполняется формирование доплонительных файлов выгрузки'");
