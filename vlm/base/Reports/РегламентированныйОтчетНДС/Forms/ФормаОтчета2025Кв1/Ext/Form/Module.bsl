...
Процедура ПроверкаКС_1_60()
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р09С271.Значение < Показатели.Р09С211.Значение;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_61()
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р09С272.Значение < Показатели.Р09С212.Значение;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_64()
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р91С351.Значение < РасчетнаяСумма;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_65()
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р91С352.Значение < РасчетнаяСумма;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
