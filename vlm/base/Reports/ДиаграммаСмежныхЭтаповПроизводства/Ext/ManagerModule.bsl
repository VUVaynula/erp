...
Функция СмежныеЭтапыИЗависимости(Параметры)
	...
	Запрос.УстановитьПараметр("КлючПартия", ?(ЗначениеЗаполнено(Параметры.КлючПартия),
												Параметры.КлючПартия,
												ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Параметры.Этап, "ПартияПроизводства").УникальныйИдентификатор()));
