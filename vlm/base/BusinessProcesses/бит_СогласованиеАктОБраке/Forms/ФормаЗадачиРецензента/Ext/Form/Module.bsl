...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РольДоступна("бит_РедактированиеБПСогласованияАктовОБраке") Тогда  
		Элементы.СрокИсполнения.Доступность = Истина;
	Иначе
		Элементы.СрокИсполнения.Доступность = Ложь;
	КонецЕсли;	
