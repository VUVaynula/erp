...
Процедура ЗаполнитьВидыДоходовПоСтраховымВзносам()
	...
	ОписатьВидДоходаПоСтраховымВзносам("НеОблагаетсяЦеликомПрокуроров",										
		НСтр("ru = 'Доходы прокуроров, следователей и судей, целиком не облагаемые страховыми взносами';
			|en = 'Income of prosecutors, investigators and judges that is fully not subject to insurance contributions'"),												Ложь,	Ложь, 	Ложь, 	Ложь,	21, , , , Истина); 
	
	ОписатьВидДоходаПоСтраховымВзносам("ОблагаетсяЦеликом",													
		НСтр("ru = 'Доходы, целиком облагаемые страховыми взносами';
			|en = 'Income fully subject to insurance contributions'"),																					Истина, Истина, Истина, Истина,	 1, , , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("ДенежноеСодержаниеПрокуроров",										
		НСтр("ru = 'Денежное содержание прокуроров, следователей и судей, не облагаемое страховыми взносами на ОПС';
			|en = 'Monetary pay to prosecutors, investigators, and judges not subject to insurance contributions to MPI'"),										Ложь, 	Истина, Истина, Истина,	20, , , Истина, Истина); 
	...
	ОписатьВидДоходаПоСтраховымВзносам("КомпенсацииОблагаемыеВзносами",										
		НСтр("ru = 'Возмещаемые ФСС компенсации, облагаемые страховыми взносами';
			|en = 'Compensations reimbursed by SSF and subject to insurance contributions'"),																		Истина, Истина, Истина, Истина,	 9, , , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("КомпенсацииОблагаемыеВзносамиПрокуроров",							
		НСтр("ru = 'Возмещаемые ФСС компенсации, облагаемые страховыми взносами, выплачиваемые прокурорам, следователям и судьям';
			|en = 'Compensations paid to prosecutors, investigators and judges, reimbursed by SSF, and subject to insurance contributions'"),						Ложь, 	Истина, Истина, Истина, 24, , , Истина, Истина); 
	ОписатьВидДоходаПоСтраховымВзносам("Матпомощь",															
		НСтр("ru = 'Материальная помощь, облагаемая страховыми взносами частично';
			|en = 'Support payments partially subject to insurance contributions'"),																		Истина, Истина, Истина, Истина,	 6,	Истина, , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьПрокуроров",												
		НСтр("ru = 'Материальная помощь прокуроров, следователей и судей, облагаемая страховыми взносами частично';
			|en = 'Support payments to prosecutors, investigators and judges partially subject to insurance contributions'"),										Ложь, 	Истина, Истина, Истина,	22,	Истина, , Истина, Истина); 
	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьПриРожденииРебенка",										
		НСтр("ru = 'Материальная помощь при рождении ребенка, облагаемая страховыми взносами частично';
			|en = 'Support payment on childbirth partially subject to insurance contributions'"),													Истина, Истина, Истина, Истина,	 7,	Истина, , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьПриРожденииРебенкаПрокуроров",								
		НСтр("ru = 'Материальная помощь при рождении ребенка прокурорам, следователям и судьям, облагаемая страховыми взносами частично';
			|en = 'Support payments on childbirth to prosecutors, investigators and judges partially subject to insurance contributions'"),				Ложь, 	Истина, Истина, Истина,	23,	Истина, , Истина, Истина); 
	ОписатьВидДоходаПоСтраховымВзносам("ДоходыСтудентовЗаРаботуВСтудотрядеПоТрудовомуДоговору",				
		НСтр("ru = 'Доходы студентов за работу в студотряде по трудовому договору';
			|en = 'Income of students for work in a students'' team under an employment contract'"),																		Ложь,	Истина, Истина, Истина,	25, , , Истина); 
	...
	ОписатьВидДоходаПоСтраховымВзносам("ДоходыСтудентовЗаРаботуВСтудотрядеПоГражданскоПравовомуДоговору",	
		НСтр("ru = 'Доходы студентов за работу в студотряде по гражданско-правовому договору';
			|en = 'Income of students for work in a students'' team under a civil law contract'"),															Ложь, 	Истина, Ложь, 	Ложь,	26, , , Истина);
	...
	ОписатьВидДоходаПоСтраховымВзносам("ОблагаетсяЦеликомНеОблагаемыеФСС_НС",								
		НСтр("ru = 'Доходы, целиком облагаемые страховыми взносами на ОПС, ОМС и соц.страхование, не облагаемые взносами на страхование от несчастных случаев';
			|en = 'Income fully subject to insurance contributions for MPI, CMI and social insurance, not subject to contributions for accident insurance'"),				Истина, Истина, Истина, Ложь,	27, , , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("ДенежноеСодержаниеПрокуроровНеОблагаемыеФСС_НС",					
		НСтр("ru = 'Денежное содержание прокуроров, следователей и судей, не облагаемое страховыми взносами на ОПС и взносами на страхование от несчастных случаев';
			|en = 'Monetary pay to prosecutors, investigators, and judges not subject to MPI insurance contributions and accident insurance contributions'"),			Ложь, 	Истина, Истина, Ложь,	28, , , Истина, Истина); 
...
Процедура ДобавитьВыплатыПоДоговорамСтудентам() Экспорт
	...
	ОписатьВидДоходаПоСтраховымВзносам("ДоходыСтудентовЗаРаботуВСтудотрядеПоДоговоруГПХОблагаемыеФСС_НС",	
		НСтр("ru = 'Доходы студентов за работу в студотряде по гражданско-правовому договору, облагаемые взносами на НС и ПЗ';
			|en = 'Income of students for work in a students'' team under a civil law contract subject to contributions for industrial accidents and occupational diseases'"), Ложь, Истина, Ложь, Истина, 43, , , Истина);
...
Процедура ДобавитьКоронавирусныеСубсидии() Экспорт
	...
	ОписатьВидДоходаПоСтраховымВзносам("КоронавирусныеСубсидии",	
		НСтр("ru = 'Суточные сверх норм, субсидии из-за эпидемии коронавирусной инфекции, облагаемые взносами на НС и ПЗ';
			|en = 'Daily allowance above quota and subsidies paid due to the coronavirus pandemic subject to contributions for industrial accidents and occupational diseases'"), Ложь, Ложь, Ложь, Истина, 44);
...
Процедура ДобавитьНеоблагаемыеВыплатыСтудентам() Экспорт
	...
	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьСтудентовИзСтудотряда",	
		НСтр("ru = 'Материальная помощь, выплачиваемая студентам студотрядов и облагаемая страховыми взносами частично';
			|en = 'Support payments to students from students'' teams that are partially subject to insurance contributions'"), Ложь, Истина, Истина, Истина, 44, Истина, , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьПриРожденииРебенкаСтудентовИзСтудотряда",	
		НСтр("ru = 'Материальная помощь при рождении ребенка, выплачиваемая студентам студотрядов и облагаемая страховыми взносами частично';
			|en = 'Support payments on childbirth to students from students'' teams that are partially subject to insurance contributions'"), Ложь, Истина, Истина, Истина, 45, Истина, , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("НеОблагаетсяЦеликомСтудентовИзСтудотряда",	
		НСтр("ru = 'Доходы студентов за работу в студотряде, целиком не облагаемые страховыми взносами';
			|en = 'Income of students for work in the a students'' team that is fully not subject to insurance contributions'"), Ложь, Ложь, Ложь, Ложь, 46); 
