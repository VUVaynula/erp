...
Процедура СохранитьДанныеСУдалениемФайлов(Форма, СтруктураПараметров) Экспорт
	...
	Форма.ЗначениеВРеквизитФормы(Документ, "Объект");
	Форма.ЗначениеВРеквизитФормы(Форма.РеквизитФормыВЗначение("ПриложенныеФайлы"), "ПриложенныеФайлыДоСохранения");
	Форма.Модифицированность = Ложь;
	Форма.Заголовок = СтрЗаменить(Форма.Заголовок, " (создание)", "");
	РегламентированнаяОтчетность.СохранитьСтатусОтправкиУведомления(Форма);
	Если ЭтоНовый Тогда 
...
Процедура ДобавлениеСтандартныхРеквизитовФормы(Форма)
	...
	Для Каждого Реквизит Из Форма.ПолучитьРеквизиты() Цикл 
		Если Реквизит.Имя = "ПриложенныеФайлы" Тогда
			Если ТипЗнч(Форма[Реквизит.Имя]) = Тип("ДанныеФормыДерево") Тогда
				ДобавляемыеРеквизиты.Очистить();
				ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ПриложенныеФайлыДоСохранения", Новый ОписаниеТипов("ДеревоЗначений")));
				Форма.ИзменитьРеквизиты(ДобавляемыеРеквизиты);
				
				ДобавляемыеРеквизиты.Очистить();
				Для Каждого Кол Из Форма.РеквизитФормыВЗначение(Реквизит.Имя).Колонки Цикл
					ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы(Кол.Имя, Новый ОписаниеТипов(Кол.ТипЗначения), "ПриложенныеФайлыДоСохранения"));
				КонецЦикла;
				Форма.ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			КонецЕсли;
			Прервать;
