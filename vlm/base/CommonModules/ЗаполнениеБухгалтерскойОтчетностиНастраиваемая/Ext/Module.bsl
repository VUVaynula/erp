...
Функция НовыйДанныеРасшифровки()
	...
	Расшифровка.Колонки.Добавить("ТипЗаписи",     ТипСтроковыйИдентификатор()); // Определяет представление строки пользователю, см. ОбщаяФорма.РасшифровкаПоказателейРегламентированныхОтчетов
	Расшифровка.Колонки.Добавить("ПредметЗаписи"); // Как правило, ссылка - например, организация, статья расходов или иной объект учета, из классификатора или соответствующий объекту реального мира
	...
	Расшифровка.Колонки.Добавить("Отчет",         Новый ОписаниеТипов("Структура")); // См. НовыйНастройкиОтчета
