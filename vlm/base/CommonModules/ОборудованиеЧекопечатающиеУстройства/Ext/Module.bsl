...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'ККС:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'ККС:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());    
	...
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС';
								|en = 'Инкотекс:ККТ с передачей данных в ОФД (ФФД 1.2) УСН НДС'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Mitsu:ККТ с передачей данных в ОФД (ФФД 1.2)';
								|en = 'Mitsu:Cash register with data transfer to FDO (FDF 1.2)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
