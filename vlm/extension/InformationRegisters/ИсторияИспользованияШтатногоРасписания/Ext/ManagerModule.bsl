...
&ИзменениеИКонтроль("ОбновитьТекущиеСведенияПозицииШтатногоРасписания")
Процедура бит_ОбновитьТекущиеСведенияПозицииШтатногоРасписания(СписокПозицийШтатногоРасписания)
	...
	#Вставка
	|	,ИсторияИспользованияШтатногоРасписания.бит_ВыплачиваетсяПремияЗаСложностьОборудования КАК бит_ВыплачиваетсяПремияЗаСложностьОборудования,
	|	ИсторияИспользованияШтатногоРасписания.бит_ВыплачиваетсяПремияЗаМногостаночноеОбслуживание КАК бит_ВыплачиваетсяПремияЗаМногостаночноеОбслуживание
	#КонецВставки
	...
	#Вставка
	|	,ДанныеПозиций.бит_ВыплачиваетсяПремияЗаСложностьОборудования КАК бит_ВыплачиваетсяПремияЗаСложностьОборудования,
	|	ДанныеПозиций.бит_ВыплачиваетсяПремияЗаМногостаночноеОбслуживание КАК бит_ВыплачиваетсяПремияЗаМногостаночноеОбслуживание
    #КонецВставки
	|ИЗ
	...
	|				ТОГДА ИСТИНА
	#Вставка
	|			КОГДА ДанныеПозиций.бит_ВыплачиваетсяПремияЗаСложностьОборудования <> ШтатноеРасписание.бит_ВыплачиваетсяПремияЗаСложностьОборудования
	|				ТОГДА ИСТИНА
	|			КОГДА ДанныеПозиций.бит_ВыплачиваетсяПремияЗаМногостаночноеОбслуживание <> ШтатноеРасписание.бит_ВыплачиваетсяПремияЗаМногостаночноеОбслуживание
	|				ТОГДА ИСТИНА
	#КонецВставки
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ";
